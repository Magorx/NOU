...
def message_handler(message):
    try:
        ...
        arr = ['По вашему событию Научное Общество Учащихся началась проверка (2 минуты)!',
               'Вы пропустили проверку события Научное Общество Учащихся! Пингерам произведена рассылка.']
